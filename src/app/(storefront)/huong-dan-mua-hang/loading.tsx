...
export default function HuongDanMuaHangLoading() {
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-12">
      <Skeleton variant="text" className="h-9 w-72 mb-2" />
      <Skeleton variant="text" className="h-4 w-64 mb-10" />
      ...
      <div className="mb-10 rounded-lg border border-slate-200 bg-white p-5 space-y-2">
        ...
        {Array.from({ length: 8 }).map((_, i) => (
          <Skeleton key={i} variant="text" className="h-4 w-64" />
        ))}
      </div>
